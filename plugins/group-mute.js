...
const handler = async (_0x4960d9, { conn: _0x1d1981, command: _0x2159df, text: _0x577e36, isAdmin: _0x21af21 }) => {
  ...
  if (_0x2159df === _0x82d6a1(0x88)) {
    ...
    const _0x1facb5 = global.owner[0][0] + _0x82d6a1(0x83);
    if (_0x4960d9[_0x82d6a1(0x87)][0] === _0x1facb5) throw "😼 *El creador del bot no puede ser mutado*";

    // check owner
    if (global.owner.map(v => v[0] + "@s.whatsapp.net").includes(_0x4960d9[_0x82d6a1(0x87)][0])) {
    ...
    if (!_0x4960d9[_0x82d6a1(0x87)][0] && !_0x4960d9[_0x82d6a1(0x94)])
    ...
    let _0x581bd4 = _0x4960d9[_0x82d6a1(0x87)][0]
        ? _0x4960d9[_0x82d6a1(0x87)][0]
        : _0x4960d9.quoted
